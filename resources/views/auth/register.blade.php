            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="mb-3">
                    <label for="reference_code" class="form-label">Referans Kodu:</label>
                    <input type="text" class="form-control" id="reference_code" name="reference" placeholder="Lütfen Referans Kodu girin" autofocus>
                  </div>
